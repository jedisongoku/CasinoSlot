...
public class Android_store : MonoBehaviour {
	...
	void OnEnable ()
	{
		if (!storeKitInited) 
		{
			Android_Payment_Manager.init ();
			storeKitInited = true;
		}

		Android_Payment_Manager.FailedPurchase += PurchaseFail;
		Android_Payment_Manager.SuccessfullPurchase += PurchaseSuccesful;
		Android_Payment_Manager.StoreIsLoaded += StoreLoaded;
...
//	}
	...
	void Buy_coin_package_1()
	{
		if(storeKitInited)
		{
			Android_Payment_Manager.purchase(Android_Payment_Manager.coin_package_one);
	...
	void Buy_coin_package_2()
	{
		if(storeKitInited)
		{
			Android_Payment_Manager.purchase(Android_Payment_Manager.coin_package_two);
			DontAllowAnyOtherPurchase();
		}
		else
		{
	...
	void Buy_coin_package_3()
	{
		if(storeKitInited)
		{
			Android_Payment_Manager.purchase(Android_Payment_Manager.coin_package_three);
			DontAllowAnyOtherPurchase();
		}
		else
		{
	...
	void Buy_coin_package_4()
	{
		if(storeKitInited)
		{
			Android_Payment_Manager.purchase(Android_Payment_Manager.coin_package_four);
			DontAllowAnyOtherPurchase();
		}
		else
		{
	...
	void Buy_coin_package_5()
	{
		if(storeKitInited)
		{
			Android_Payment_Manager.purchase(Android_Payment_Manager.coin_package_five);
			DontAllowAnyOtherPurchase();
		}
		else
		{
	...
	void Buy_coin_package_6()
	{
		if(storeKitInited)
		{
			Android_Payment_Manager.purchase(Android_Payment_Manager.coin_package_six);
			DontAllowAnyOtherPurchase();
		}
		else
		{
	...
	void Buy_coin_package_offer_1()
	{
		if(storeKitInited)
		{
			Android_Payment_Manager.purchase(Android_Payment_Manager.coin_package_offer_one);
			DontAllowAnyOtherPurchase();
		}
		else
		{
	...
	void Buy_coin_package_offer_2()
	{
		if(storeKitInited)
		{
			Android_Payment_Manager.purchase(Android_Payment_Manager.coin_package_offer_two);
			DontAllowAnyOtherPurchase();
		}
		else
		{
	...
	void Buy_coin_package_offer_3()
	{
		if(storeKitInited)
		{
			Android_Payment_Manager.purchase(Android_Payment_Manager.coin_package_offer_three);
			DontAllowAnyOtherPurchase();
		}
		else
		{
